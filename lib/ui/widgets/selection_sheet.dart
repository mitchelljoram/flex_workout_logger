                    ...
                    if (isRequired)
                      Text(
                        ...
                        style: state.context.textTheme.bodySmall.copyWith(
                          color: state.context.colorScheme.foregroundSecondary,
                        ),
                      ),
                  ],
                ),
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: state.hasError
                          ? Theme.of(state.context)
                              ...
                              .error
                              .withOpacity(0.5)
                          : state.context.colorScheme.backgroundTertiary,
                    ),
                    child: Row(
                      children: [
          ...
          child: Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  context.colorScheme.backgroundTertiary.withOpacity(0),
                  context.colorScheme.backgroundTertiary,
                ],
                stops: const [
                  0,
                  0.65,
